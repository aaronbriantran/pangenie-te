#!/bin/bash
#SBATCH --job-name=3_vcfstats
#SBATCH --partition=general
#SBATCH --nodes=1
#SBATCH --ntasks-per-node=1
#SBATCH --cpus-per-task=1
#SBATCH --time=1:00:00
#SBATCH --output=/scratch/atran/final/3_pangenie/logs/3_vcfstats_%a.log
#SBATCH --error=/scratch/atran/final/3_pangenie/logs/3_vcfstats_%a.err
#SBATCH --array=1,7,9
...
vcf="${donorname}_alt_biallelic.vcf"

ml bcftools

bcftools stats --af-bins 0.1,0.5,1 --fasta-ref /scratch/atran/final/3_pangenie/input_files/CHM13v11Y.fa ${vcf} > ${donorname}_stats.txt
