#!/bin/bash
#SBATCH --job-name=3_vcf
#SBATCH --partition=general
#SBATCH --nodes=1
#SBATCH --ntasks-per-node=1
#SBATCH --cpus-per-task=1
#SBATCH --time=3:00:00
#SBATCH --output=/scratch/atran/final/3_pangenie/logs/3_vcf_%a.log
#SBATCH --error=/scratch/atran/final/3_pangenie/logs/3_vcf_%a.err
#SBATCH --array=1,7,9
...
./binaries/PanGenie-vcf -f ./index/pangenome -z ./pangenie_outputs/${donorname}_genotyping.cereal -s ${donorname} -o ./vcfs/${donorname}

#oops, this line is slightly wrong! i've fixed the issues in biallelic.sh
#cat ./vcfs/${donorname}_genotyping.vcf | python3 ./binaries/convert_to_biallelic.py ./input_files/biallelic.vcf > ./vcfs/${donorname}_genotyping_biallelic.vcf
