...
#   plot-vcfstats --sample-names -p F1_plots F1_stats.txt
#
# Edit as necessary and recreate the plots by running
#   python3 plot.py
#
# Title abbreviations:
# 	 0 .. F1_al .. F1_alt_biallelic.vcf
#
...
if 0 in dat and len(dat[0])>2:
    ax1.plot([row[0] for row in dat[0]], [row[1] for row in dat[0]], '-o',markersize=3, color='orange',mec='orange',label='F1_al')
    has_data = 1
