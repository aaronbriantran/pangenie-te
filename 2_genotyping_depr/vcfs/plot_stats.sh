#!/bin/bash
#SBATCH --job-name=3_plotstats
#SBATCH --partition=general
#SBATCH --nodes=1
#SBATCH --ntasks-per-node=1
#SBATCH --cpus-per-task=1
#SBATCH --time=1:00:00
#SBATCH --output=/scratch/atran/final/3_pangenie/logs/3_plotstats_%a.log
#SBATCH --error=/scratch/atran/final/3_pangenie/logs/3_plotstats_%a.err
#SBATCH --array=1,7,9
...
/opt/apps/bcftools/1.18/misc/plot-vcfstats --sample-names -p ${donorname}_plots ${donorname}_stats.txt
