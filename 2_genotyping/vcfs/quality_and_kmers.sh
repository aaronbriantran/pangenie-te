#!/bin/bash
#SBATCH --job-name=3_qandk
#SBATCH --partition=general
#SBATCH --nodes=1
#SBATCH --ntasks-per-node=1
#SBATCH --cpus-per-task=1
#SBATCH --time=1:00:00
#SBATCH --output=/scratch/atran/final/3_pangenie/logs/3_qandk_%a.log
#SBATCH --error=/scratch/atran/final/3_pangenie/logs/3_qandk_%a.err
#SBATCH --array=1,7,9
...
bcftools query -H -f '%ID\t%INFO/UK\tGQ:[ %GQ]\n' ${donorname}_alt_biallelic.vcf > ${donorname}_quality.txt
